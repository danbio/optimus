...
| HSP por cidade (NASA POWER + IBGE) | 🟡 Pesquisado, não implementado | Testado: Gurupi retorna 5,51 kWh/m²/dia (o padrão do ERP é 5,50). Encadeamento IBGE (UF→município→centroide) → NASA POWER funciona, grátis e sem chave. Traz valor **mensal**, daria pra mostrar curva sazonal |
