...
| Sincronizar HSP de outras UFs | 🔲 Quando precisar | Só o TO está sincronizado. Para propor em GO/PA/MA/MT, rodar `importar_municipios --uf XX` e `sincronizar_hsp --uf XX` (leva alguns minutos por UF) |
